...
String sql = "SELECT userName , userPhone, userPassword FROM user WHERE userNum = ?";
...
while(rs.next()) 
{
	...
	u_phone = rs.getString("userPhone");
	u_pw = rs.getString("userPassword");
}
 ...
 %>
	Home > 회원 수정
	<hr>
	<form action="modi_check.jsp" name="modi_info" 
