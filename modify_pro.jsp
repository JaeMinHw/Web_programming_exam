...
String sql = "SELECT proName , proPhone, proPassword FROM protecter WHERE userNum = ?";
...
while(rs.next()) 
{
	u_name = rs.getString("proName");
	u_phone = rs.getString("proPhone");
	u_pw = rs.getString("proPassword");
}
 ...
 %>
	Home > 회원 수정
	<hr>
	<form action="modi_check_pro.jsp" name="modi_info" 
